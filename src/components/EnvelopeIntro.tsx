...
export function EnvelopeIntro({ onComplete }: EnvelopeIntroProps) {
  ...
  const handleSealClick = () => {
    ...
    setTimeout(() => setPhase("invitation"), 2200);
  };
  ...
  const isAnimating = phase === "breaking" || phase === "opening" || phase === "sliding";
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            opacity: phase === "invitation" || phase === "rsvp" || phase === "submitted" ? 0 : 1,
            transition: "opacity 0.6s ease",
            pointerEvents: isAnimating || phase !== "sealed" ? "none" : "auto",
          }}
        >
          {/* Envelope body */}
          <div
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 3px 10px rgba(107,16,16,0.35), inset 0 2px 4px rgba(255,255,255,0.12), inset 0 -2px 6px rgba(0,0,0,0.25)",
          ...
          {/* INVITATION CARD (inside envelope, slides up) */}
          <div
            ...
            style={{
              ...
              ...(phase === "sliding" || phase === "invitation" || phase === "rsvp" || phase === "submitted"
                ? { bottom: "calc(100% + 40px)", opacity: 1 }
        ...
        {phase === "sealed" && (
          <p
            className="mt-8 text-[10px] uppercase tracking-[0.4em] font-semibold animate-fade-up"
...
/* ════════════════════════════════════════════════════════════════════════════
   INVITATION CARD — shows wedding details, then transitions to RSVP form
   ════════════════════════════════════════════════════════════════════════════ */
  ...
  return (
    <div
      ...
      style={{
        ...
        minHeight: showRsvp || showSubmitted ? "min(520px, 80vh)" : "auto",
    ...
    >
      ...
      <div
        className="h-[2px]"
        style={{ background: "linear-gradient(90deg, transparent, #8B1A1A 30%, #8B1A1A 70%, transparent)" }}
      />
      ...
      {showSubmitted ? (
        ...
        <div className="px-5 py-6 sm:px-8 sm:py-8 animate-fade-up" style={{ animationDuration: "0.6s" }}>
          <div className="text-center mb-5">
            <p className="text-[9px] uppercase tracking-[0.4em] font-bold mb-1" style={{ color: "rgba(139,26,26,0.5)" }}>
              RSVP
            </p>
          ...
          {error && (
            <div className="p-3 bg-red-50 border-l-3 border-red-400 text-red-800 text-xs rounded-lg mb-4 leading-relaxed">
              {error}
            </div>
          )}
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div>
              <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-slate-600 mb-1">
            ...
            <div>
              <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-slate-600 mb-2">
                ...
                {[
                  ...
                  return (
                    <button
                      key={item.value}
                      type="button"
                      onClick={() => onCheckboxChange(item.value)}
                      className={`w-full text-left px-4 py-2.5 rounded-xl border text-sm flex items-center gap-3 transition-all duration-200 ${
                        checked
                    ...
                    >
                      ...
                      >
                        {checked && (
                          <svg viewBox="0 0 12 12" className="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex flex-col items-center text-center px-6 py-8 sm:py-10">
          ...
          <p className="text-[8px] uppercase tracking-[0.5em] font-bold mb-1" style={{ color: "rgba(139,90,43,0.4)" }}>
            The Wedding of
          </p>
          ...
          <p className="text-[10px] uppercase tracking-[0.25em] font-bold text-slate-700 mb-0.5">
            Friday, 11 September 2026
          </p>
          <p className="text-[10px] uppercase tracking-[0.25em] font-bold text-slate-700 mb-0.5">
            Saturday, 12 September 2026
          </p>
          <p className="text-[9px] uppercase tracking-[0.2em] text-slate-400 mt-1 mb-6">
            Abuja, Nigeria
          </p>
