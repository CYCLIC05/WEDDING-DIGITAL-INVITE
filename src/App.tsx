...
import { 
  Heart, Calendar, MapPin, Sparkles, Key, ChevronRight, MessageSquare, ShieldAlert, CheckCircle, Info
} from "lucide-react";
...
export default function App() {
      ...
      <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#FAF4F0] px-6 selection:bg-[#BF3B52] selection:text-white">
        ...
        <div className="text-center mt-8 space-y-2 z-10 max-w-sm">
          ...
          <div className="flex items-center justify-center space-x-2 my-2">
            ...
            <Heart className="w-3 h-3 text-[#BF3B52] fill-[#BF3B52]" />
            <div className="h-[1px] w-8 bg-[#C29D70]/40"></div>
          </div>
  ...
  return (
    <div className="bg-[#FAF4F0] text-slate-800 font-sans selection:bg-[#BF3B52] selection:text-white min-h-screen flex flex-col justify-between relative overflow-x-hidden">
      ...
      {/* GLOBAL HEADER BAR */}
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#C29D70]/20 px-6 py-4 shadow-xs">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            {view === "guest" ? (
              <>
                <nav className="hidden lg:flex items-center space-x-6 text-[10px] font-sans font-bold uppercase tracking-widest text-slate-600">
                  <a href="#about" className="hover:text-[#BF3B52] transition-colors">Our Covenant</a>
                  <button 
                  ...
                  <a href="#rsvp-section" className="hover:text-[#BF3B52] transition-colors">RSVP Register</a>
                </nav>
                
                <a 
                  href="#rsvp-section"
                  className="px-6 py-2.5 bg-[#BF3B52] hover:bg-[#9E2B3E] text-white font-sans text-[10px] uppercase font-bold tracking-widest transition duration-300 shadow-sm rounded-full border border-[#C29D70]/40"
                >
                  Register RSVP
                </a>
                ...
                <button
                  ...
                  className="p-2.5 border border-[#C29D70]/30 text-[#BF3B52] hover:bg-[#BF3B52]/5 transition rounded-full cursor-pointer"
                >
                  <Key className="w-4 h-4 text-[#BF3B52]" />
                </button>
              </>
            ) : (
              <>
                <button
                  onClick={() => changeView("guest")}
                  className="px-6 py-2.5 border border-[#BF3B52] text-[#BF3B52] hover:bg-[#BF3B52] hover:text-white font-sans text-[10px] uppercase font-bold tracking-widest transition duration-300 rounded-full cursor-pointer"
                >
      ...
      <main className="flex-grow">
        {view === "admin" ? (
          ...
          <div className="animate-fade-in pb-12">
            ...
            <section className="relative max-w-5xl mx-auto my-8 overflow-hidden rounded-3xl border-4 border-double border-[#C29D70] bg-[#1E1114] bg-[url('https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1200&q=80')] bg-cover bg-center shadow-2xl select-none">
              ...
              <div className="relative z-20 flex justify-center -mt-6">
                <div className="relative w-32 h-32 transform transition hover:scale-105 duration-300">
                  ...
                  <div className="absolute inset-2 rounded-full bg-white flex flex-col items-center justify-center text-center shadow-lg border border-[#BF3B52]/20 z-10 px-3">
                    ...
                    <Heart className="w-3.5 h-3.5 text-[#BF3B52] fill-[#BF3B52] my-1 animate-pulse" />
